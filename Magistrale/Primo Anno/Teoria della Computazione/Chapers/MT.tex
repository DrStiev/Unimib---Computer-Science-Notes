...
peggiori. Si hanno: 
\begin{itemize}
  \item \textbf{algoritmi in tempo polinomiale rispetto alla dimensione dell'input}
  \item \textbf{algoritmi in tempo esponenziale rispetto alla dimensione dell'input, sono dimostrabilmente intrattabili}
\end{itemize}
...
\subsubsection{Relazione di Transizione}
...
\subsubsection{Accettabilità e Deidibilità}
